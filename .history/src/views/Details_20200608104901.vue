       ...
       <!-- 标题 -->
          <div>
            ...
            <div class="release">
                ...
                <div class="spot">●</div>
                <div>作者</div>
                <div v-if="detail.author">{{detail.author.loginname}}</div>
                <div class="spot">●</div>
...
<!-- 回复内容 -->
      <div class="el--input--width">
          <el-card class="cards">
            ...
            <div v-for="item in detail.replies" :key="item.id" class="replies">
                <img :src="item.author.avatar_url" alt="" class="avatar">
                <div class="author">
                    <div class="loginname">{{item.author.loginname}}</div>{{item.index+1}}
